/*=========================================================================
  ...
  Copyright (c) 2011 Goodwin Lawlor
  All rights reserved.
...
// .SECTION Description
// This 3D widget defines a region of interest that is represented by a
// cylinder bounded by two faces. The object creates 3 handles that can be moused 
// on and manipulated. The first two correspond to the two faces, the third is in
